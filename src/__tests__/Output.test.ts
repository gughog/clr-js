...
it('::: Mix formatting tests :::', () => {
  expect(clr.red('My red and bold string').bold().it()).toBe('\033[1m\x1b[31mMy red and bold string\x1b[0m\033[0m');
  expect(clr.bold('My bold and underlined text').uline().it()).toBe('\033[4m\033[1mMy bold and underlined text\033[0m\033[0m');
})